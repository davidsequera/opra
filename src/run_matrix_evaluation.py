...
LOG_REGISTRY: dict[str, dict] = {
    "AcademicCredentials": {
        ...
        "checkpoint_full": _ckpt("AcademicCredentials_DDPS_p75_300_400_tp90_tk2_pe30_a0_full"),
        "checkpoint_resource_only": _ckpt("AcademicCredentials_DDPS_p75_300_400_tp90_tk2_pe30_a0_resource_only"),
        "masks": dict(top_k=2, top_p=0.9, p_min_end=0.3),
        "train_percentile": 75,
    },
    "BPIC_2012": {
        "path": "data/logs/BPIC_2012/BPIC_2012_train.csv",
        "checkpoint_full": _ckpt("BPIC_2012_DDPS_p75_300_3000_tp90_tk2_pe30_a0_full"),
        "checkpoint_resource_only": _ckpt("BPIC_2012_DDPS_p75_300_3000_tp90_tk2_pe30_a0_resource_only"),
        "masks": dict(top_k=2, top_p=0.9, p_min_end=0.3),
        "train_percentile": 75,
    },
    "BPIC_2017": {
        "path": "data/logs/BPIC_2017/BPIC_2017_train.csv",
        "checkpoint_full": _ckpt("BPIC_2017_DDPS_p75_300_7400_tp90_tk3_pe10_a0_full"),
        "checkpoint_resource_only": _ckpt("BPIC_2017_DDPS_p75_300_7400_tp90_tk3_pe10_a0_resource_only"),
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default="data/evaluation_results/matrix")
